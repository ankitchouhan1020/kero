...
struct CommandPaletteView: View {
    ...
    private var commands: [PaletteCommand] {
        var items: [PaletteCommand] = [
            ...
            PaletteCommand(id: "new-project", title: "New Space", systemImage: "square.stack.3d.up", shortcut: "⌘N") {
        ...
        if let project = manager.selectedProject {
            items.append(
                PaletteCommand(id: "remove-space", title: "Remove Space “\(project.name)”…", systemImage: "folder.badge.minus") {
