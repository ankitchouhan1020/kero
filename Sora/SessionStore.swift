...
struct SessionSnapshot: Codable {
    struct ProjectSnapshot: Codable {
        ...
        struct TabSnapshot: Codable {
            ...
            /// Optional so pre-Spaces snapshots can derive the safe default.
            var isPinned: Bool?

            init(
                columns: [ColumnSnapshot], focusedColumn: Int, focusedRow: Int,
                customName: String? = nil, isPinned: Bool? = nil
            ) {
            ...
            enum CodingKeys: String, CodingKey {
                case columns, focusedColumn, focusedRow, customName, isPinned
            }
        ...
        var customName: String?
        /// User-owned Space glyph. Optional for snapshots created before
        /// Space icons were supported.
        ...
        /// Repository roots attached to the Space. Optional for snapshots
        /// written before Spaces supported multiple repositories.
    ...
    /// Legacy field retained only so older snapshots remain source-compatible;
    /// the contextual header is now always visible.
    var isMainHeaderVisible: Bool? = nil
