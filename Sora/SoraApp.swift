...
struct SoraApp: App {
    @NSApplicationDelegateAdaptor(SoraApplicationDelegate.self)
...
private struct SoraCommands: Commands {
    ...
    var body: some Commands {
        ...
        CommandGroup(after: .pasteboard) {
            // SwiftUI's Edit menu ships no Find submenu, so Sora owns these
