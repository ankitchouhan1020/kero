...
/// Provides Sora's Finder service. The advertised menu item lives in
/// Info.plist; AppKit forwards matching service requests to this object.
@MainActor
final class SoraApplicationDelegate: NSObject, NSApplicationDelegate {
    ...
    /// project in the active Sora window.
    @objc func openInSora(
        ...
        guard !directories.isEmpty else {
            error.pointee = "Select one or more folders to open in Sora." as NSString
            return
        }
