...
extension PaneContent {
    ...
    @MainActor var systemImage: String {
        ...
        case .file(let file): return file.systemImage
...
final class PaneTab: nonisolated ObservableObject, nonisolated Identifiable {
    ...
    /// User-owned lifecycle: pinned tabs stay in the durable top section;
    /// temporary tabs can be cleared as a safe batch.
    ...
    init(columns: [PaneColumn], focusedPaneID: UUID, isPinned: Bool) {
