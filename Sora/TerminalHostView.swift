...
struct TerminalHostView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> NSView {
        ...
        // Sora's visual insets live inside the backend as window padding (see
        // SoraTerminalView+Ghostty), so that a padding-color of `extend` can
...
/// behavior Sora had before the backend migration without drawing those panes
