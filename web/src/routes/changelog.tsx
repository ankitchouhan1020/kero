...
const CONTRIBUTORS_URL =
  'https://api.github.com/repos/ankitchouhan1020/sora/contributors?per_page=1&anon=1'
...
export const Route = createFileRoute('/changelog')({
  ...
  head: () => ({
    meta: [
      { title: 'Changelog — Sora' },
      {
        name: 'description',
        content: 'The latest improvements, fixes, and new features in Sora.',
      },
    ],
  }),
  component: Changelog,
...
function Changelog() {
  ...
  return (
    <SiteLayout>
      ...
      <section
        aria-label={`The last ${RELEASES.length} Sora releases`}
